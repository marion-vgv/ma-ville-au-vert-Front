const formModule = {
  ...
  handleSearchForm: async (event) => {
    ...
    if (formData.get('location') === 'region' && isNaN(parseInt(formData.get('locationRegion')))) {
        ...
        formBlock.addEventListener("click", ()=>{fieldRegion.classList.remove("error")});
  ...
  if (formData.get('location') === 'department' && isNaN(parseInt(formData.get('locationDepartment')))) {
        ...
        formBlock.addEventListener("click", ()=>{fieldDepartment.classList.remove("error")});
    } 
  ...
  if (formData.get('type') === 'urbaine' && isNaN(parseInt(formData.get('uu')))) {
      ...
      formBlock.addEventListener("click", ()=>{fieldUU.classList.remove("error")});
  } 
  ...
  if (parseInt(formData.get('townMin')) > parseInt(formData.get('townMax'))) {
      ...
      formBlock.addEventListener("click", ()=>{fieldMin.classList.remove("error"); fieldMax.classList.remove("error");});
  }    
  ...
  if (formData.get('school') === 'true' && formData.get('schoolOptions') === null) {
    ...
    formBlock.addEventListener("click", ()=>{fieldSchool.classList.remove("error")});
  } 
